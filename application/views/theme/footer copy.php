<footer class="footer">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <img width="150" src="<?php echo base_url('');?>style/img/tut-wuri-handayani-7759.pn" class="rounded" alt="Muris Studio">
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <li><a href="<?php echo site_url('about');?>">Tentang Masjid</a></li>
                            <li><a href="<?php echo site_url('artikel');?>">Berita Masjid</a></li>
                            <li><a href="<?php echo site_url('galeri');?>">Galeri Masjid</a></li>
                            <li><a href="<?php echo site_url('contact');?>">Alamat Masjid</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <ul>
                                <li><a href="<?php echo site_url('guru');?>">Daftar pengurus masjid</a></li>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> <a href="https://dimasdwipr.my.id/" target="_blank">| dwipr.tech</a> </p>
                        </p>
                    </div>
                </div>
            </div>
